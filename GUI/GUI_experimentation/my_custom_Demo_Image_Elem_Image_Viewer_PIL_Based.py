...
# left_col = [[sg.Text('Game Live Cast')],
#             [sg.Listbox(values=[], enable_events=True, size=(40, 20), key='-FILE LIST-')],
#             [sg.Text('Resize to'), sg.In(key='-W-', size=(5, 1)), sg.In(key='-H-', size=(5, 1))]]
...
# left_col = [[sg.Text('Folder'), sg.In(size=(25, 1), enable_events=True, key='-FOLDER-')],
#             [sg.Listbox(values=[], enable_events=True, size=(40, 20), key='-FILE LIST-')],
#             [sg.Text('Resize to'), sg.In(key='-W-', size=(5, 1)), sg.In(key='-H-', size=(5, 1))]]

# Left col images  dialog
images_col = [[sg.Text('You choose from the list:')],
              [sg.Image(key='-IMAGELEFT-')]]

# For now will only show the name of the file that was chosen
# images_col = [[sg.Text('You choose from the list:')],
#               [sg.Image(key='-IMAGERIGHT-')]]
#
# ----- Full layout -----
layout = [
