...
# It draws boxes, obj_scores, and labels around the obj_centroids of interest in the image.
...
IMAGE_NAME = 'slaying_obj_dect_284.jpg'

# Grab full_path to current working directory
CWD_PATH = os.getcwd()
