...
class Grid(GridBase):
    ...
    def set_mouse_click_action(self, function):
        print(f"self.__mouse_click_action: {function}")
        self.__mouse_click_action = function

    def set_cell_click_action(self, function):
        print(f"self.__cell_click_action: {function}")
        ...
        while True:
            for event in pygame.event.get():  # User did something
                if event.type == pygame.KEYDOWN:
                    ...
                    print(f"event.type == pygame.MOUSEBUTTONUP: {event.type == pygame.MOUSEBUTTONUP}")
                    pos = pygame.mouse.get_pos()
                    print(f"pos: {pos}")
                    self.__mouse_click_action(pos)
                    print(f"self.__mouse_click_action(pos): {self.__mouse_click_action(pos)}")
            ...
            # --- Limit to x traj_frames_dataset per second
...
if __name__ == '__main__':
    ...
    cell_width = 8
    cell_height = 8
    grid = Grid(num_row_cells, num_col_cells, cell_width, cell_height, title='2D Grid World', margin=1)
    # grid[0, 0] = 'O'
    # grid[1, 1] = 'X'
    # grid[2, 1] = 'O'
    # grid[2, 2] = 'X'
