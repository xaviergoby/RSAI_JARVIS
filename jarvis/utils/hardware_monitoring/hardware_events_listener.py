import settings
from jarvis.utils.hardware_monitoring import mouse_events_listener
from jarvis.utils.hardware_monitoring import keyboard_events_listener
from src.utils import time_tools
import pyautogui


class HardwareEventsListener:
	...
	def init_mouse_states(self):
		init_mouse_states = mouse_events_listener.get_init_mouse_states(settings.mouse_nVirtKey_dict)
		self.current_mouse_states = init_mouse_states

	def init_keyboard_states(self):
		init_keyboard_states = keyboard_events_listener.get_init_keyboard_states(settings.keyboard_nVirtKey_dict)
	...
	def get_mouse_states_change_events(self):
		mouse_states_change_events = mouse_events_listener.get_mouse_click_events(self.current_mouse_states,
	...
	def lmb_clicked(self):
		...
		lmb_clicked = mouse_events_listener.mouse_button_clicked(mouse_states_change_events,
	...
	def get_keyboard_states_change_events(self):
		keyboard_states_change_events = keyboard_events_listener.get_keyboard_click_events(self.current_keyboard_states,
	...
	def P_clicked(self):
		...
		p_clicked = keyboard_events_listener.keyboard_key_clicked(keyboard_states_change_events, ["P"])
	...
	def T_clicked(self):
		keyboard_states_change_events = self.get_keyboard_states_change_events()
		t_clicked = keyboard_events_listener.keyboard_key_clicked(keyboard_states_change_events, ["T"])
	...
	def C_clicked(self):
		keyboard_states_change_events = self.get_keyboard_states_change_events()
		c_clicked = keyboard_events_listener.keyboard_key_clicked(keyboard_states_change_events, ["C"])
	...
	def I_clicked(self):
		keyboard_states_change_events = self.get_keyboard_states_change_events()
		i_clicked = keyboard_events_listener.keyboard_key_clicked(keyboard_states_change_events, ["I"])
	...
	def R_clicked(self):
		keyboard_states_change_events = self.get_keyboard_states_change_events()
		r_clicked = keyboard_events_listener.keyboard_key_clicked(keyboard_states_change_events, ["R"])
		if r_clicked is True:
			return True
		else:
			return False
	...
	def keyboard_clicked(self):
		...
		R_clicked = self.R_clicked
		if P_clicked is True or T_clicked is True or C_clicked is True or I_clicked is True or R_clicked is True:
			return True
		else:
			return False
	...
	def update_current_mouse_states(self):
		...
		new_mouse_states = mouse_events_listener.update_mouse_states(old_mouse_states, mouse_click_events)
	...
	def update_current_keyboard_states(self):
		...
		new_keyboard_states = keyboard_events_listener.update_keyboard_states(old_keyboard_states, keyboard_click_events)
